...
| 🤗 Hugging Face | |
| --- | --- |
| **Models published** | 5,089 |
| **Datasets published** | 78 |
| **Downloads, all time** | **852M** |
...
<sub>Live from the <a href="https://huggingface.co/MaziyarPanahi">Hugging Face Hub API</a> · refreshed 23 September 2026</sub>
<!-- HF-STATS:END -->
